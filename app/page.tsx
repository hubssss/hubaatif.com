  ...
  const faqs = [
    {
      ...
      answer: "I specialize in modern web technologies including React, Next.js, TypeScript, Node.js, and various UI/UX design tools like Figma and Adobe Creative Suite."
    },
    {
    ...
    },
    {
      ...
      answer: "Yes! I provide post-launch support and maintenance packages to ensure your website continues to perform optimally."
    },
    {
  ...
  const testimonials = [
    {
      name: "Alex Johnson",
      role: "CEO, TechStart",
      content: "Huba delivered an exceptional website that exceeded our expectations. His attention to detail and technical expertise are outstanding.",
      rating: 5
    },
    {
      name: "Sarah Miller",
      role: "Marketing Director",
      content: "Working with Huba was a pleasure. He understood our vision perfectly and created a beautiful, functional design.",
      rating: 5
    },
    {
      name: "David Chen",
      role: "Founder, InnovateCo",
      content: "Professional, creative, and reliable. Huba transformed our ideas into a stunning digital experience.",
      rating: 5
    }
  ];
  ...
  return (
    <>
      ...
      >
        ...
        <nav className="fixed top-0 w-full bg-black/80 backdrop-blur-md z-50 border-b" style={{ borderColor: 'rgba(155, 89, 182, 0.3)' }}>
            ...
            <div className="hidden md:flex space-x-8">
              {['Home', 'Services', 'Work', 'About', 'FAQ'].map((item) => (
                <motion.button
                  ...
                  style={{
                    color: activeSection === item.toLowerCase() ? '#9b59b6' : undefined
                  }}
                >
                  {item}
                  {activeSection === item.toLowerCase() && (
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 relative z-10">
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              >
                Software Engineer & UI/UX Designer crafting beautiful, functional solutions that drive results.
              </motion.p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Which package is <span style={{ color: '#9b59b6' }}>right for you?</span>
            </h2>
            <p className="text-xl text-gray-400">Choose the perfect solution for your needs</p>
          </motion.div>
          ...
          >
            {services.map((service, index) => (
              <motion.div
                ...
                style={{
                  borderColor: service.popular ? '#9b59b6' : 'rgba(155, 89, 182, 0.3)'
                }}
                variants={fadeInUp}
              >
                {service.popular && (
                  ...
                  >
                    <span className="text-white px-4 py-1 rounded-full text-sm font-medium" style={{ backgroundColor: '#9b59b6' }}>
                      Most Popular
                    </span>
                  </motion.div>
                )}
                <h3 className="text-2xl font-bold mb-2">{service.title}</h3>
                <p className="text-4xl font-bold mb-6" style={{ color: '#9b59b6' }}>
                  {service.price}
                </p>
                <ul className="space-y-3 mb-8">
                  {service.features.map((feature, i) => (
                    ...
                    >
                      <svg className="w-5 h-5 mr-3 mt-0.5 flex-shrink-0" style={{ color: '#9b59b6' }} fill="currentColor" viewBox="0 0 20 20">
      ...
      <section id="work" className="py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            {[
              { title: "E-Commerce Platform", tech: "Next.js, Stripe, PostgreSQL", color: "from-purple-600 to-purple-800" },
              { title: "SaaS Dashboard", tech: "React, Node.js, MongoDB", color: "from-pink-600 to-pink-800" },
              { title: "Mobile App Design", tech: "Figma, React Native", color: "from-purple-500 to-pink-500" },
              { title: "Corporate Website", tech: "WordPress, Custom Theme", color: "from-purple-700 to-purple-900" },
              { title: "Web Application", tech: "Vue.js, Firebase", color: "from-pink-700 to-pink-900" },
              { title: "Design System", tech: "Storybook, Tailwind CSS", color: "from-purple-600 to-pink-600" }
            ].map((project, index) => (
              <motion.div
                key={project.title}
              ...
              >
                ...
                <h3 className="text-xl font-bold mb-2 transition-colors duration-300" style={{ color: 'white' }}>
                  {project.title}
                </h3>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-center">
            ...
            >
              <h2 className="text-4xl md:text-5xl font-bold mb-6">
                The right <span style={{ color: '#9b59b6' }}>skills</span> are essential
              </h2>
              <p className="text-xl text-gray-400 mb-8">
                With years of experience in software engineering and UI/UX design, I bring a unique blend of technical expertise and creative vision to every project.
              </p>
            ...
            >
              {[
                ...
                { icon: "🎨", title: "Creative Design", desc: "Unique & modern designs" },
                { icon: "📱", title: "Responsive", desc: "Works on all devices" },
                { icon: "🔒", title: "Secure Code", desc: "Best security practices" }
              ].map((item, index) => (
                <motion.div
                  key={item.title}
                ...
                >
                  ...
                  <h3 className="font-bold mb-1" style={{ color: '#9b59b6' }}>{item.title}</h3>
          ...
          >
            {testimonials.map((testimonial, index) => (
              ...
              >
                ...
                <div>
                  <p className="font-bold" style={{ color: '#9b59b6' }}>{testimonial.name}</p>
      ...
      <section id="faq" className="py-20 bg-black/50">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <h2 className="text-4xl md:text-5xl font-bold mb-4">
              Help Center: <span style={{ color: '#9b59b6' }}>Questions? Answers.</span>
            </h2>
          </motion.div>
          ...
          >
            {faqs.map((faq, index) => (
              ...
              >
                ...
                >
                  <span className="font-medium text-lg text-gray-300">{faq.question}</span>
                  <svg
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <button 
              ...
              onMouseEnter={(e) => {
                e.currentTarget.style.boxShadow = '0 0 20px rgba(155, 89, 182, 0.4)';
              }}
              onMouseLeave={(e) => {
                e.currentTarget.style.boxShadow = 'none';
              }}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            <div className="mb-4 md:mb-0">
              <p className="text-sm text-gray-400">© 2024 Huba Atif. All rights reserved.</p>
              <p className="text-sm mt-1" style={{ color: '#9b59b6' }}>Software Engineer & UI/UX Designer</p>
            </div>
